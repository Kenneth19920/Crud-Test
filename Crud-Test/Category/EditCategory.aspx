<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCategory.aspx.cs" Inherits="Crud_Test.EditCategory" MasterPageFile="~/Site.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2 class="text-center mb-4"><i class="fa fa-plus"></i> Formulario para editar categoría</h2>
    <br>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCategoryName" runat="server" CssClass="form-control" ClientIDMode="Static" onkeypress="return validateInput(event);"></asp:TextBox>
                    ...
                    <div class="form-group d-flex justify-content-between">
                        ...
                        <asp:Button ID="btnEdit" runat="server" Text="Editar Categoria" OnClick="btnEdit_Click" CssClass="btn btn-outline-success" />
