<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertCategory.aspx.cs" Inherits="Crud_Test.InsertCategory" MasterPageFile="~/Site.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <br>
    <br>

    <h2 class="text-center mb-4"><i class="fa fa-plus"></i> Formulario para agregar Categoría</h2>
    <br>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCategoryId" runat="server" CssClass="form-control" placeholder="Números Enteros"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCategoryName" runat="server" CssClass="form-control" ClientIDMode="Static" placeholder="Ej. Electrónicos"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control dropdown-control" ID="ddlIsActive" runat="server">
                    ...
                    <div class="form-group d-flex justify-content-between">
                        ...
                        <asp:Button ID="btnInsertCategory" runat="server" Text="Agregar Categoria" OnClick="btnInsertCategory_Click" CssClass="btn btn-outline-success" />
